...
ifeq ($(config),debug)
  RESCOMP = windres
  TARGETDIR = bin/Debug
  TARGET = $(TARGETDIR)/dimlit-test
  OBJDIR = obj/Debug/dimlit-test
  DEFINES += -DDEBUG
  INCLUDES +=
  FORCE_INCLUDE +=
  ...
  LIBS += bin/Debug/libdimlit-lib.a
...
ifeq ($(config),release)
  ...
  TARGET = $(TARGETDIR)/dimlit-test
  OBJDIR = obj/Release/dimlit-test
  DEFINES += -DNDEBUG
  INCLUDES +=
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ...
  ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CFLAGS)
  ALL_RESFLAGS += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  LIBS += bin/Release/libdimlit-lib.a
